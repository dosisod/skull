...
test "declare/bool_expr" "is.sk"
test "declare/bool_expr" "not.sk"
test "declare/bool_expr" "var_rhs.sk"
test "declare/bool_expr" "and.sk"
test "declare/bool_expr" "or.sk"
test "declare/bool_expr" "xor.sk"
test "declare/bool_expr" "less_than.sk"
test "declare/bool_expr" "gtr_than_eq.sk"
test "declare/bool_expr" "less_than.sk"
test "declare/bool_expr" "gtr_than_eq.sk"
test "declare/bool_expr" "is_not.sk"
...
test "flow/if" "empty_body.sk"
test "flow/if" "false.sk"
test "flow/if" "true.sk"
test "flow/if" "with_var_false.sk"
test "flow/if" "with_var_true.sk"
test "flow/if" "else_comment.sk"
test "flow/if" "not_with_const.sk"
test "flow/if" "not_with_var.sk"
