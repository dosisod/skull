...
test_skull "asm_print_to_stdout.sh" "./test/sh/skull/dummy.sk -S -o -"
...
test_skull "duplicate_arg.sh --color" "--color --color"
test_skull "duplicate_arg.sh -o" "-o file_a -o file_b"
test_skull "duplicate_arg.sh -o" "-o file_a -o"
