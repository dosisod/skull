...
void classify_token(Token *const token) {
	...
	TOKEN_TRY_STR(U"unreachable", TOKEN_KW_UNREACHABLE)
	...
	TOKEN_TRY_STR(U"mod", TOKEN_OPER_MOD)
	TOKEN_TRY_STR(U":=", TOKEN_OPER_AUTO_EQUAL)
	TOKEN_TRY_STR(U"not", TOKEN_OPER_NOT)
	TOKEN_TRY_STR(U"is", TOKEN_OPER_IS)
	TOKEN_TRY_STR(U"isnt", TOKEN_OPER_ISNT)
	TOKEN_TRY_STR(U"and", TOKEN_OPER_AND)
	TOKEN_TRY_STR(U"or", TOKEN_OPER_OR)
	TOKEN_TRY_STR(U"xor", TOKEN_OPER_XOR)
	TOKEN_TRY_STR(U"<", TOKEN_OPER_LESS_THAN)
	TOKEN_TRY_STR(U">", TOKEN_OPER_GTR_THAN)
